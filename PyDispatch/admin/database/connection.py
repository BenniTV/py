"""
PyDispatch Admin – Datenbank-Verbindungsverwaltung.
...
class DatabaseConnection:
    ...
    def test_connection(self, host: str, port: int, user: str, password: str, database: str = None) -> tuple[bool, str]:
    ...
    def execute_modify(self, query: str, params: tuple = None) -> int:
        """Führt eine INSERT/UPDATE/DELETE-Query aus und gibt die betroffenen Zeilen zurück."""
        cursor = self.get_cursor()
        try:
            cursor.execute(query, params)
